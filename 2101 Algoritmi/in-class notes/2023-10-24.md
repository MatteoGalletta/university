...
- Se c'è una collisione, viene fatta una
style X fill:BLACK,color:WHITE
style D fill: RED "seconda domanda" alla funzione hash, per ottenere un'altro indirizzo. Questo metodo però non è efficace, potrebbero esserci ulteriori collisioni.
