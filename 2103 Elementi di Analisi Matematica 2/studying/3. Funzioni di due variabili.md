...
2. Si calcolano le restrizioni rispetto ai segmenti di $A$.
	...
	- es. Se la restrizione è una retta obliqua, si trova l'equazione della retta passante per i due punti e si trova la legge che associa $x$ a $y$).
1. Si calcola la derivata prima e si pone uguale a $0$.
2. Si calcola il valore della funzione nei punti trovati.
