...
- Criterio di Leibniz:
	...
	- Vale inoltre $|s-s_{n}|\leq a_{n+1} \quad \forall\,n \in \mathbb{N}$
- Criterio di non regolarità:
	- se $a_{n}$ è crescente ed ha almeno un termine positivo, oppure decrescente ed $\lim a_{n}\neq0$, la serie è **INDETERMINATA**
